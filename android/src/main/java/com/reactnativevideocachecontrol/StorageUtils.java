...
final class StorageUtils {
    ...
    private static File getCacheDirectory(Context context, boolean preferExternal) {
        ...
        if (appCacheDir == null) {
            ...
            Log.w("VideoCacheControl","Can't define system cache directory! '" + cacheDirPath + "%s' will be used.");
    ...
    private static File getExternalCacheDir(Context context) {
        ...
        if (!appCacheDir.exists()) {
            if (!appCacheDir.mkdirs()) {
                Log.w("VideoCacheControl","Unable to create external cache directory");
                return null;
            }
        }
        return appCacheDir;
